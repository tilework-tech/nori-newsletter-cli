...
- All AWS SES API calls (contact management, individual and bulk email sending, account quota queries, account-level suppression list management, contact list management, account health, delivery metrics, and email template management) flow through this single service layer
